...
import { SALES_CLOSED, PICKUP_DATE } from '@/lib/sales';
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10 h-9 flex items-center justify-center text-center gap-3 sm:gap-5 overflow-hidden">
          {SALES_CLOSED ? (
            <p className="font-mono text-[10px] sm:text-[11px] uppercase tracking-[0.18em] truncate">
              <span className="text-flame-red font-semibold">Pembelian ditutup</span>
              <span className="opacity-40 mx-1.5">/</span>
              Pickup <span className="text-gold font-semibold">{PICKUP_DATE}</span>
              <span className="opacity-40 mx-1.5">/</span>
              Bring <span className="text-flame-purple font-semibold">receipt + ref no</span>
            </p>
          ) : (
            <p className="font-mono text-[10px] sm:text-[11px] uppercase tracking-[0.18em] truncate">
