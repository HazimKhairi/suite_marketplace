          ...
          >
            ...
            <div className="col-span-2">
              <input
                ...
                className="w-28 h-9 border border-line bg-paper px-2 font-mono text-[13px]"
              />
              <p className="font-mono text-[10px] text-muted mt-1">{formatMYR(price)}</p>
            </div>
            <div className="col-span-2">
              <input
                type="number"
                ...
                className="w-24 h-9 border border-line bg-paper px-2 font-mono text-[13px]"
              />
            </div>
